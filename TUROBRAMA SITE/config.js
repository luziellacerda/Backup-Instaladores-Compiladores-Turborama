...
window.TURBORAMA_CONFIG = {
  ...
  // Slides automáticos da página única. Coloque imagens ou vídeos dentro da pasta assets/slides/.
  // Formatos aceitos: imagem .jpg .png .webp .svg | vídeo .mp4 .webm .ogg
  slidesMobileIntervalo: 5200,
  slidesMobile: [
    { tipo: "imagem", arquivo: "assets/slides/slide-01.svg", etiqueta: "Organização", titulo: "Biblioteca bonita e organizada", texto: "Mostre o visual do sistema, capas, categorias e navegação de forma rápida." },
