...
$outDir = Join-Path $releaseDir "Protegido_MAXIMO"

Write-Host "=== TURBORAMA ROM LINKER - BUILD + PROTEÇÃO MÁXIMA ===" -ForegroundColor Cyan
...
$crproj = Join-Path $proteção "ConfuserEx_Turborama_MAXIMO.crproj"
& $confuser $crproj
...
Write-Host "" 
Write-Host "PROTEÇÃO MÁXIMA FINALIZADA" -ForegroundColor Green
