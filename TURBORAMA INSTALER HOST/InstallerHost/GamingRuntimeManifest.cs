	...
	internal static class GamingRuntimeManifest
	{
		...
		private static List<GamingRuntimeComponent> BuildComponents()
		{
			...
			items.Add(CreatePackage(
				"vc-modern-x64", "Microsoft Visual C++ 2015–2022 x64", GamingRuntimeCategory.MicrosoftRuntime, GamingRuntimeTier.Required,
			...
			items.Add(CreatePackage(
				"vc-modern-x86", "Microsoft Visual C++ 2015–2022 x86", GamingRuntimeCategory.MicrosoftRuntime, GamingRuntimeTier.Required,
