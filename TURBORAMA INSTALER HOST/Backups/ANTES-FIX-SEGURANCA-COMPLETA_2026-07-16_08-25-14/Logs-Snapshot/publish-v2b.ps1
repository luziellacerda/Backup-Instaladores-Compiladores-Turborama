...
$log = "C:\TurboRama\Logs\publish-v2b.log"
...
if ($LASTEXITCODE -eq 0) {
  ...
  L ("OK DLL=" + (Get-Item "C:\TurboRama\App\Launcher\TurboRama.Launcher.dll").LastWriteTime)
}
Set-Content C:\TurboRama\Logs\publish-v2b-done.flag (Get-Date -Format o)
