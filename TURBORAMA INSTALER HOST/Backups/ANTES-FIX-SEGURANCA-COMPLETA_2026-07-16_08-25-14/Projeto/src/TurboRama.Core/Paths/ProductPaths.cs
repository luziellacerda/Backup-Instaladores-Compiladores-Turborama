...
public static class ProductPaths
{
    ...
    /// <summary>
    /// Pedido de energia escrito pelos scripts ES (quit/shutdown/reboot)
    /// e consumido pelo Launcher. Valores: shutdown | reboot | quit
    /// </summary>
    public static string PowerRequestFile => Path.Combine(State, "power-request.txt");
