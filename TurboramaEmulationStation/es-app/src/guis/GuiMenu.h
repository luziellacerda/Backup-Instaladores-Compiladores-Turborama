...
private:
        ...
        void requestDeveloperSettingsAccess();
...
public:
	...
	// TurboRama: bezel por nome de pasta/sistema (sem precisar de FileData/SystemData)
	static std::vector<DecorationSetInfo> getDecorationsSetsByName(const std::string& systemName);
