...
void Settings::setDefaults()
{
	...
	mStringMap["ThemeSet"] = "__turborama__";
	...
	// TurboRama: screensaver so usa videos da pasta junto ao EXE (screensaver_videos)
	// Estrutura padrao ES: screensaver_videos/{sistema}/qualquer_nome.mp4
	// Recurse=true para ler subpastas de sistema (bezel reconhece a pasta)
	mBoolMap["SlideshowScreenSaverCustomVideoSource"] = true;
	mStringMap["SlideshowScreenSaverVideoDir"] = ""; // vazio = Paths/ES/screensaver_videos
	mStringMap["SlideshowScreenSaverVideoFilter"] = ".mp4,.avi,.mkv,.webm,.mov";
	mBoolMap["SlideshowScreenSaverVideoRecurse"] = true;
	// Moldura (bezel) de sistema no screensaver
	mStringMap["ScreenSaverDecorations"] = "systems";
