...
public:
	...
	void setGameSplashScreen(const std::string& systemName, std::string fallbackImage, std::string customText, IBindable* bindable = nullptr);
	bool playGameEntrySplash(const std::string& systemName);
	void displayGameExitSplash(const std::string& systemName);
	...
	void playBlockingGameSplash(const GameSplash::Media& media);
