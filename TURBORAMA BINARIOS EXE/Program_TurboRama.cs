...
namespace RetroBat
{
	internal class Program
	{
		...
		private const string OldAppName = "RetroBat";
		private const string OldAppExe = "RetroBat.exe";
		private const string IniFileName = "turborama.ini";
		private const string OldIniFileName = "retrobat.ini";
		private const string IniSection = "TurboRama";
		private const string OldIniSection = "RetroBat";
		...
		private static string ConvertLegacyIniContent(string content)
		{
			...
			return content
				...
				.Replace("RetroBat", "TurboRama")
				.Replace("RETROBAT", "TURBORAMA")
				.Replace("retrobat-neon.mp4", IntroVideoFileName)
				.Replace("retrobat.ini", IniFileName)
				.Replace("retrobat", "turborama");
		}
