...
REM Scripts ES (Desligar/Reiniciar) se existir pasta no pack
if exist "%SRC%\Frontend\emulationstation-scripts\shutdown" (
  if exist "D:\Turborama\emulationstation\.emulationstation\scripts" (
    xcopy "%SRC%\Frontend\emulationstation-scripts\*" "D:\Turborama\emulationstation\.emulationstation\scripts\" /E /Y /Q >nul
  )
)
exit /b 0
