...
internal static class Program
{
        ...
        ITurboRamaLogger logger)
    {
        ...
        try
        {
            ...
            // Resolve path real (flat D:\TurboRama.exe ou pasta D:\Turborama\...) se já existir no PC
            {
                string resolved = FactoryDefaults.ResolveFrontendExecutable(
                ...
                {
                    config.FrontendExecutable = resolved;
                }
            }
