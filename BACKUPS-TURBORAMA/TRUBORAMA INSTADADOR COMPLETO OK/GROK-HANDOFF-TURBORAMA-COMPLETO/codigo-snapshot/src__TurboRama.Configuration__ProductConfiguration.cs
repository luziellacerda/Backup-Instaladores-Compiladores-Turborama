...
public sealed class ProductConfiguration
{
    ...
    /// <summary>
    /// EXE do jogo. Preferido: D:\Turborama\TurboRama.exe (pasta).
    /// Em PC com layout flat (D:\TurboRama.exe) o seed/Launcher resolve via FactoryDefaults.
    /// </summary>
    public string FrontendExecutable { get; set; } = FactoryDefaults.PreferredFrontendExecutable;
