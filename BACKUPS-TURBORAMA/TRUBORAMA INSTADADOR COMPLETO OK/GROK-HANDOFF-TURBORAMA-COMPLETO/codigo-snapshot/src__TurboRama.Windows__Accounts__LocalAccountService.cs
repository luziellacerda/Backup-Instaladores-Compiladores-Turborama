...
public static class LocalAccountService
{
    ...
    public static OperationResult CreateStandardUser(string userName, string password)
    {
        ...
        // Alinhado a FactoryDefaults.MinKioskPasswordLength (8) e senha de fábrica Lz2026@$
        if (string.IsNullOrEmpty(password) || password.Length < 8)
        {
            return OperationResult.Fail("Senha kiosk deve ter no mínimo 8 caracteres.", "ACCT_PWD", "CreateStandardUser");
        }
