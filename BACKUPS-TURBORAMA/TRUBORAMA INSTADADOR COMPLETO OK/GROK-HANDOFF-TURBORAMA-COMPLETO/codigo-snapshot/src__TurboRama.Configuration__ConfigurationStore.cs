...
public static class ConfigurationStore
{
    ...
    public static ProductConfiguration CreateDefault() => new()
    {
        ...
        // Preferido: pasta D:\Turborama; runtime resolve flat D:\TurboRama.exe via FactoryDefaults
        FrontendExecutable = FactoryDefaults.PreferredFrontendExecutable,
        Profile = "KioskBasic",
