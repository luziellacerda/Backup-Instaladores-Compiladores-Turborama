	...
	public partial class MainForm : BaseForm
	{
		...
		protected override void OnFormClosing(FormClosingEventArgs e)
		{
			if ((this._install != null && this._install.IsExtractionInProgress) ||
				(this._prerequisite != null && this._prerequisite.IsPrerequisiteInstallInProgress))
			{
				e.Cancel = true;
				MessageBox.Show(this,
					"Aguarde a etapa em andamento e sua validação terminarem antes de fechar o instalador.",
		...
		{
			if (disposing)
				foreach (UserControl page in new UserControl[] { _welcome, _license, _prerequisite, _install, currentControl })
					if (page != null && !page.IsDisposed) page.Dispose();
