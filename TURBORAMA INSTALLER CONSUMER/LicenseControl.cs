...
this.wizardHeader.Text = ConsumerText.GetString("LicenseIntro", Array.Empty<object>());
			this.licenseTextBox.Text = ConsumerText.GetString("LicenseText", Array.Empty<object>());
			this.chkAgree.Text = ConsumerText.GetString("AgreeText", Array.Empty<object>());
			this.btnCancel.Text = ConsumerText.GetString("Cancel", Array.Empty<object>());
			this.btnNext.Text = ConsumerText.GetString("Next >", Array.Empty<object>());
